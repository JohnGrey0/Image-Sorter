...
def main():
    ...
    favorite = '.{}sorted{}favorites{}'.format(slash, slash, slash)
    logger.info('Creating favorite folder variable: {}'.format(favorite))
    others = '.{}sorted{}others{}'.format(slash, slash, slash)
    ...
    favs = retrieve_resolutions(os.path.abspath('fav_resolutions.txt'.format(slash, slash))) # only wanna call this once
